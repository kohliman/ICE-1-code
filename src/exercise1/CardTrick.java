 ...
 * @author Salman Ibrahim 01/02/2023
 */
...
//card.setValue(insert call to random number generator here)
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Salman Ibrahim");
        System.out.println();
        
        System.out.println("My career ambitions: Becoming a Senior developer");
        System.out.println("-- Work a remote job to be able to travel");
        System.out.println("-- Get fantastic grades");
	System.out.println();	
